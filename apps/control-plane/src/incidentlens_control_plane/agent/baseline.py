"""Deterministic baseline investigation engine.

Preserves the original synchronous-start, checkpoint-loop engine
unchanged for regression testing and the explicit baseline runtime mode.
"""
